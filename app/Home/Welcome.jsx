...
const Welcome = () => {
    return (
        <div className="relative flex items-center justify-center h-[50vh] md:h-[80vh] bg-cover bg-[center_top] bg-[url('/hero-7.jpg')]">
            <div className="flex flex-col items-center justify-center text-white">
                ...
                <p className='mt-5 p-5 text-wrap text-lg max-w-[60%]'>
